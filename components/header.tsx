...
export default function Header() {
  ...
  return (
    <header>
      <nav className="z-40 bg-bg fixed top-0 left-0 w-full flex md:hidden justify-between items-center py-4 px-[5vw]">
        <a href="/">
          <Logo sizew={97} sizeh={64} />
        </a>
            ...
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
              ...
              <defs>
                <clipPath id="clip0_537_781">
                  <rect width="44" height="44" className="fill-bg" />
                </clipPath>
              </defs>
            </svg>
          </div>
        </div>
        <ul className="flex flex-col gap-6 text-4xl w-full">
          <li>Accueil</li>
          <li>Actualités</li>
          <li className="cursor-pointer">
            <div className="w-fit px-6 py-2 bg-button-reverse text-text-reverse rounded text-xl">Télécharger</div>
          </li>
          <li className="cursor-pointer flex flex-col gap-4 w-full">
            ...
            <div className={`bg-bg p-4 text-text flex flex-col gap-3 w-full justify-start items-start rounded text-base ${accessibilityMobile ? "flex" : "hidden"}`}>
              <div className="flex flex-col gap-4">
                <p className="min-w-max">{`Contraste :`}</p>
                <div className="flex gap-2">
                  <button onClick={() => switchTheme("light")} className="bg-bg-reverse text-text-reverse font-custom px-4 py-2 min-w-max rounded-full">
                    Par défault
                  </button>
                  <button onClick={() => switchTheme("theme1")} className="bg-bg-reverse text-text-reverse font-custom px-4 py-2 min-w-max rounded-full">
                    Renforcé
                  </button>
                  <button onClick={() => switchTheme("theme2")} className="bg-bg-reverse text-text-reverse font-custom px-4 py-2 min-w-max rounded-full">
                    Inversé
                  </button>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2">
                  <button onClick={() => switchFontTheme("default")} className="min-w-max border-2 border-custom font-custom px-4 py-2 rounded-full">
                    Par défault
                  </button>
                  <button onClick={() => switchFontTheme("font1")} className="min-w-max border-2 border-custom font-custom px-4 py-2 rounded-full">
                    Adapté
                  </button>
                </div>
              </div>
      ...
      <nav
        ...
        <ul className="flex gap-5 items-center">
          ...
          <li className="cursor-pointer">
            <div className="w-fit px-6 py-2 bg-button-reverse text-text-reverse rounded">Télécharger</div>
          </li>
          <li className="cursor-pointer">
            <div onClick={toggleAccessibility} className="w-fit px-6 py-2 bg-transparent text-text border-custom border-2 rounded">
              Accessibilité
            </div>
            ...
            <div className={`fixed top-0 left-0 w-full h-screen ${accessibility ? "block" : "hidden"}`}>
              ...
              <div className="absolute top-20 right-[5vw] bg-bg p-4 text-text flex flex-col gap-3 justify-start items-start w-fit rounded">
